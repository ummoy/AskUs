		...
		<tr >
			...
			<td align = "center" width = "70%">
				<table class = "content" align = "center" width = "100%">
					<tr class = "content">	
						<td colspan = "4" class = "header" align = "center"><h2 >Members</h2></td> 								
					</tr>	
					<c:if test="${fn:length(listuser) > 0}">
					<c:forEach items="${listuser}" var="user">
					<tr class = "content">
						<td class = "col-sm-2" id = "vote"><img id = "dimension" src = "${pageContext.request.contextPath}/resources/images/1.jpg"/> <!-- displays the picture of the user -->.
						</td>
						<td class = "col-sm-10" id = "hit">Name:&nbsp;${user.user_fname}&nbsp;${user.user_lname} <br>Em@il:&nbsp;${user.user_email}<!-- displays the name of the user -->
						</td>
