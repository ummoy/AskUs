		...
		<tr >
			...
			<td align = "center" width = "70%">
				<table class = "content" align = "center" width = "100%">
					<tr class = "content">	
						<td colspan = "4" class = "header" align = "center"><h2 >Common Tags</h2></td> 								
					</tr>	
					<c:if test="${fn:length(listtags) > 0}">
					<c:forEach items="${listtags}" var="tags" varStatus="loop">
					<tr class = "content">
						<td class = "col-sm-1" id = "hit">${tags.tags_count}<br>Hits <!-- number of times this tag has been hit -->
						</td>
						<td class = "col-sm-5" id = "ans"><a href = "posts/${tags.tags_name}">${tags.tags_name}</a> <!-- name of the tag -->
						</td>
						<td class = "col-sm-1" id = "hit">${tags.tags_count}<br>Hits<!-- number of times this tag has been hit -->
						</td>
						<td class = "col-sm-5" id = "ans"><a href = "posts/${tags.tags_name}">${tags.tags_name}</a>
						</td>
						</td>
					</tr>
					</c:forEach>
