	...
	<table class = "content" width = "100%" >
		<tr >
			...
			<td align = "center" width = "70%">
				...
				<c:forEach items="${showpost}" var="post">
					<tr class = "content">	
						<td colspan = "4" class = "header" align = "center"><h2 >${post.post_title}</h2> 
						<h4 class = "details"> ${post.post_details}</h4>
												
										<h5 class = "details">posted by ${post.post_by} on ${post.post_date }</h5>
										<h5 class = "details">tags :&nbsp;${post.post_keywords}</h5>
				...
				<c:forEach items="${showcomment}" var="comment">
					<tr class = "content">
						<td class = "col-sm-1" id = "hit">#<%=i+1%> <!-- top answers in ascending order -->
						</td>
						<td class = "col-sm-10" id = "ans">${comment.post_details} <!-- answer to the particular question -->
						<table>
								<tr>
									<td class = "details">
										<h5>posted by ${comment.post_by} on ${comment.post_date }</h5>
									</td>
								</tr>
				...
				<table class = "content" align = "center" width = "90%" >	
					<tr >
						...
						<form action="${pageContext.request.contextPath}/search" method="GET" commandName="post">
							<input align = "centre" type = "text" name="post_keywords">
		...
		<tr>
			<td>
				<form action="${pageContext.request.contextPath}/posts/${post_id}/${post_title}/${sessionScope.uname}" method="POST" commandName="comment">
				<div class="form-group">
						<label for="exampleInputTitle">Post your answer</label>
						<textarea class="form-control" placeholder="your answer" id="inputAnswer" cols="30" rows="10" name="post_details"></textarea>
				</div>
				
				<div><a href = "#">
	<button type="submit" class = "btn btn-primary btn-lg" name="postsubmit" id="postsubmit"  value="post">Post</button></a> 
	 <br>  <br>
	</div>
			</form>	
			</td>
   		...
   		<c:if test="${sessionScope.uname == null}">	
			...
			<td>
				...
				<form action="${pageContext.request.contextPath}/post/answer" method="post">
				<div class="form-group">
						<label for="exampleInputTitle">Post your answer</label>
						<textarea class="form-control" placeholder="your answer" name="" id="inputAnswer" cols="30" rows="10"></textarea>
				</div>
				
				<div><a href = "#">
	<button type="submit" class = "btn btn-primary disabled btn-lg" name="postsubmit" id="postsubmit"  value="post">Post</button></a> 
	 <br>  <br>
	</div>
			</form>	
			</td>
